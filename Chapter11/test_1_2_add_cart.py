...
class TestAddCart(object):
    ...
    def test_add_cart(self, book_name, author, target):
        ...
        # 单击加入购物车按钮
        self.driver.find_element(AppiumBy.IOS_CLASS_CHAIN, '**/XCUIElementTypeStaticText[`label == "加入购物车"`]').click()
        ...
        book_name1 = self.driver.find_element(AppiumBy.IOS_PREDICATE, 'label CONTAINS "{}"'.format(book_name)).get_attribute('name')
